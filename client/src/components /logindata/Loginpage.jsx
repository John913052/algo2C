...
const Loginpage = ({open,setopen}) => {
    ...
    const handelinput=async(signupdata)=>{
                ...
                <Box sx={{display:'flex',height:'80%'}}>
                    ...
                    </Imgwarper>
                    {
                       account.view==='signup'?
                        ...
                        <Loginboxwarpper >
                            ...
                            <Button variant="outlined" type='button' onClick={()=>handelinput(signupdata)}  sx={{color:'red',margin:'20px 0px',width:'100%'}}>Signup</Button>
                    ...
                    :
                        <Loginboxwarpper >
                            ...
                            <TextField onChange={(e)=> inpubox(e)} style={{width: '100%',margin:'6px 0px'}} label="Enter your Email" variant="standard" name='Email'/>
                            <TextField onChange={(e)=> inpubox(e)} style={{width: '100%',margin:'6px 0px'}} label="Enter your password" variant="standard" name='Password'/>
                            <Button variant="outlined" type='button' onClick={()=>handelinput(signupdata)}  sx={{color:'red',margin:'20px 0px',width:'100%'}}>LogIn</Button>
